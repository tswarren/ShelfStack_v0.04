...
module Seeds
  module Phase85Permissions
    POS_ACTIONS = %w[void].freeze
    SETUP_RESOURCES = %w[discount_reasons].freeze
    ...
    def self.permissions
      resource_permissions("pos", "discounts", POS_ACTIONS, "POS discounts") +
