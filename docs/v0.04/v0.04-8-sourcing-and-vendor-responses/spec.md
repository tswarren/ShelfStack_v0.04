...
**Complete** — delivered in v0.04-8 ([completion](../../implementation/v0.04-8-completion.md)). Depends on [v0.04-7 completion](../../implementation/v0.04-7-completion.md) (merged).
