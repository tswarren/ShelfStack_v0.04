...
| v0.04-14 Product/catalog cleanup | **Proposed target state** | [planning roadmap](../roadmap/v0.04-14-product-catalog-cleanup.md) · [wireframes](../roadmap/v0.04-14-product-catalog-wireframes.md) · [multi-stage workflows](../roadmap/v0.04-14-multi-stage-workflow-presentation.md) |
