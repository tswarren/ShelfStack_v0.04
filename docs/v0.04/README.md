...
**Current priority:** milestone **v0.04-11** documentation and schema cleanup. **v0.04-3** product groups remains **deferred**.
...
| v0.04-11 Doc and schema cleanup | **In progress** | [spec](v0.04-11-documentation-schema-cleanup/spec.md) · [audit log](v0.04-11-documentation-schema-cleanup/data-model.md) · [test plan](v0.04-11-documentation-schema-cleanup/test-plan.md) |
