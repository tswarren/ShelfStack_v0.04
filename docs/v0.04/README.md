...
**Current priority:** milestone **v0.04-9** PO/receiving quantity model (**in review** on branch `v0.04-9-po-receiving-quantity-model`). **v0.04-3** product groups remains **deferred**.
...
| v0.04-9 PO/receiving quantities | **In review** | [spec](v0.04-9-po-receiving-quantity-model/spec.md) · [data model](v0.04-9-po-receiving-quantity-model/data-model.md) · [test plan](v0.04-9-po-receiving-quantity-model/test-plan.md) · [completion draft](../implementation/v0.04-9-completion.md) |
