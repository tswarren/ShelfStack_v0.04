...
**Current priority:** **v0.04-14 Design System UX Migration** (active) — next release milestone; implemented as Phase 10-E. v0.04-0 through v0.04-13 **complete**. v0.04-3 product groups and readiness-tier slices (B, E2, R) deferred.
