...
**Current priority:** milestone **v0.04-7** allocations and reservations. **v0.04-3** product groups remains **deferred**.
...
| v0.04-7 Allocations | **Planned** | [spec](v0.04-7-allocations-and-reservations/spec.md) · [data model](v0.04-7-allocations-and-reservations/data-model.md) · [test plan](v0.04-7-allocations-and-reservations/test-plan.md) |
