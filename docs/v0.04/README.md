...
**Current priority:** milestone **v0.04-7** allocations and reservations (**in review** on branch). **Next after merge:** v0.04-8 sourcing. **v0.04-3** product groups remains **deferred**.
...
| v0.04-7 Allocations | **In review** | [spec](v0.04-7-allocations-and-reservations/spec.md) · [data model](v0.04-7-allocations-and-reservations/data-model.md) · [test plan](v0.04-7-allocations-and-reservations/test-plan.md) · [completion](../implementation/v0.04-7-completion.md) |
| v0.04-8 Sourcing | Planned (next after v0.04-7 merge) | *(not yet created)* |
