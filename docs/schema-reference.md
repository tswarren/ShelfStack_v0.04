...
Phase 7B also extends `pos_tenders` with settlement columns (7B-1) and stored-value linkage columns (`stored_value_account_id`, `stored_value_identifier_id`, 7B-3). See [phase-7b-data-model.md](specifications/phase-7b-data-model.md).
