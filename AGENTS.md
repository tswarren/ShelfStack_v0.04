...
## Phase 10-C: POS Keyboard Workspace — **In progress** (slices 1–8; 9 in review; **9B** and **10** pending)

See [docs/implementation/phase-10c-completion.md](docs/implementation/phase-10c-completion.md). Authoritative direction: [docs/roadmap/phase-10c-pos-keyboard-workspace.md](docs/roadmap/phase-10c-pos-keyboard-workspace.md), [docs/specifications/phase-10c-pos-keyboard-workspace-spec.md](docs/specifications/phase-10c-pos-keyboard-workspace-spec.md). Tender/completion UX: [docs/roadmap/phase-10c-9b-tender-workspace-and-completion.md](docs/roadmap/phase-10c-9b-tender-workspace-and-completion.md).
