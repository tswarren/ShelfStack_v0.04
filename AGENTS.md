...
**v0.04-2 (product identifiers):** **In review** — [spec bundle](docs/v0.04/v0.04-2-product-identifiers/spec.md) · [completion](docs/implementation/v0.04-2-completion.md).

**v0.04-3 (product groups):** **Deferred** — roadmap retained; not scheduled before v0.04-5.

**v0.04-4 (variant-grain wire-through):** **In review** — [spec bundle](docs/v0.04/v0.04-4-variant-grain-wire-through/spec.md) · [completion](docs/implementation/v0.04-4-completion.md). Merge after v0.04-2.

**Current priority:** **v0.04-5** used variant rules after v0.04-4 merge.
