...
**v0.04-3 (product groups):** **Deferred** — roadmap retained; not scheduled before v0.04-6.
...
**v0.04-9 (PO and receiving quantity model):** **In review** — branch `v0.04-9-po-receiving-quantity-model` · [spec bundle](docs/v0.04/v0.04-9-po-receiving-quantity-model/spec.md) · [completion draft](docs/implementation/v0.04-9-completion.md).

**Current priority:** **v0.04-9** merge review; **v0.04-10** next after merge.
